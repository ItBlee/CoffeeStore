...
public class LichSuMapper implements RowMapper<LichSu>, ExcelRowMapper<LichSu> {
    @Override
    public LichSu mapRow(ResultSet resultSet) {
        try {
    ...
    @Override
    public void mapExcelBody(LichSu dto, Row row) {
        Cell cell;
    ...
    @Override
    public LichSu mapExcelToDto(LichSu dto, int columnIndex, String cellValue) {
        if (dto == null)
            dto = new LichSu();
