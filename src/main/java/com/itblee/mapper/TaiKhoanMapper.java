...
public class TaiKhoanMapper implements RowMapper<TaiKhoan>, ExcelRowMapper<TaiKhoan> {
    @Override
    ...
    @Override
    public void mapExcelBody(TaiKhoan dto, Row row) {
        Cell cell;
    ...
    @Override
    public TaiKhoan mapExcelToDto(TaiKhoan dto, int columnIndex, String cellValue) {
        if (dto == null)
            dto = new TaiKhoan();
