...
import com.itblee.gui.components.IEventSwitchSelected;
import com.itblee.gui.components.SwitchJButton;
...
public class FormPhanQuyen extends JPanel {
    ...
    private void initComponents() {
        ...
        cbRole.addItemListener(e -> onSelectedRoleListener());
        add(cbRole);
        ...
        switchJButtonPN.addEventSelected(selected -> {
        ...
        switchJButtonNCC.addEventSelected(selected -> {
        ...
        switchJButtonKH.addEventSelected(selected -> {
        ...
        switchJButtonKM.addEventSelected(selected -> {
        ...
        switchJButtonTK.addEventSelected(selected -> {
        ...
        switchJButtonExcel.addEventSelected(selected -> {
        ...
        switchJButtonNV.addEventSelected(selected -> {
        ...
        switchJButtonHD.addEventSelected(selected -> {
        ...
        btnThem.addActionListener(e -> onClickBtnThemListener());
        ...
        btnRenew.addActionListener(e -> onClickBtnRenewListener());
        ...
        for (Component component: functionPanel.getComponents()) {
            if (component instanceof JCheckBox)
                ((JCheckBox)component).addChangeListener(e -> setSaveStatus(false));
        }
    }
    ...
    private void onSelectedRoleListener() {
        ...
        List<PhanQuyen> roleList = phanQuyenService.findAll();
        PhanQuyen selectedRole = roleList.get(selectedIndex-1);

        txtMaPQ.setText("PQ" + selectedRole.getMaPQ());
        txtTenPQ.setText(selectedRole.getTenPQ());

        CT_PhanQuyen getFunctionHD = ctPhanQuyenService.findByID(selectedRole.getQuyenHD());
        CT_PhanQuyen getFunctionSP = ctPhanQuyenService.findByID(selectedRole.getQuyenSP());
        CT_PhanQuyen getFunctionPN = ctPhanQuyenService.findByID(selectedRole.getQuyenPN());
        CT_PhanQuyen getFunctionNCC = ctPhanQuyenService.findByID(selectedRole.getQuyenNCC());
        CT_PhanQuyen getFunctionKH = ctPhanQuyenService.findByID(selectedRole.getQuyenKH());
        CT_PhanQuyen getFunctionKM = ctPhanQuyenService.findByID(selectedRole.getQuyenKM());
        CT_PhanQuyen getFunctionTK = ctPhanQuyenService.findByID(selectedRole.getQuyenTK());
        CT_PhanQuyen getFunctionExcel = ctPhanQuyenService.findByID(selectedRole.getQuyenExcel());
        CT_PhanQuyen getFunctionNV = ctPhanQuyenService.findByID(selectedRole.getQuyenNV());
    ...
    private Role getRole() {
        ...
        if (role.getPhanQuyen().getMaPQ() != null) {
            role.setPhanQuyen(phanQuyenService.findByID(dto.getMaPQ()));
        }

        role.getPhanQuyen().setTenPQ(txtTenPQ.getText());

        CT_PhanQuyen ctHD = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctSP = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctPN = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctNCC = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctKH = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctKM = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctTK = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctExcel = new CT_PhanQuyen();
        ...
        CT_PhanQuyen ctNV = new CT_PhanQuyen();
    ...
    private void onClickBtnThemListener() {
        try {
            Role role = getRole();
            if (!ValidateUtil.isValidName(role.getPhanQuyen().getTenPQ()))
                throw new Exception("Tên quyền không hợp lệ.");
            role.getPhanQuyen().setQuyenHD(ctPhanQuyenService.save(role.getQuyenHD()));
            role.getPhanQuyen().setQuyenSP(ctPhanQuyenService.save(role.getQuyenSP()));
            role.getPhanQuyen().setQuyenPN(ctPhanQuyenService.save(role.getQuyenPN()));
            role.getPhanQuyen().setQuyenNCC(ctPhanQuyenService.save(role.getQuyenNCC()));
            role.getPhanQuyen().setQuyenKH(ctPhanQuyenService.save(role.getQuyenKH()));
            role.getPhanQuyen().setQuyenKM(ctPhanQuyenService.save(role.getQuyenKM()));
            role.getPhanQuyen().setQuyenTK(ctPhanQuyenService.save(role.getQuyenTK()));
            role.getPhanQuyen().setQuyenExcel(ctPhanQuyenService.save(role.getQuyenExcel()));
            role.getPhanQuyen().setQuyenNV(ctPhanQuyenService.save(role.getQuyenNV()));
            phanQuyenService.save(role.getPhanQuyen());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void onClickBtnXoaListener() {
        try {
            ...
            phanQuyenService.delete(role.getPhanQuyen().getMaPQ());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void onClickBtnSuaListener() {
        try {
            ...
            if (!ValidateUtil.isValidName(role.getPhanQuyen().getTenPQ()))
                throw new Exception("Tên quyền không hợp lệ.");
            phanQuyenService.update(role.getPhanQuyen());
            ctPhanQuyenService.update(role.getQuyenHD());
            ctPhanQuyenService.update(role.getQuyenSP());
            ctPhanQuyenService.update(role.getQuyenPN());
            ctPhanQuyenService.update(role.getQuyenNCC());
            ctPhanQuyenService.update(role.getQuyenKH());
            ctPhanQuyenService.update(role.getQuyenKM());
            ctPhanQuyenService.update(role.getQuyenTK());
            ctPhanQuyenService.update(role.getQuyenExcel());
            ctPhanQuyenService.update(role.getQuyenNV());
        } catch (Exception e) {
            e.printStackTrace();
