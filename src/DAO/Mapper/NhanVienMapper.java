...
public class NhanVienMapper implements IRowMapper<NhanVienDTO>, IExcelRowMapper<NhanVienDTO> {
    @Override
    ...
    @Override
    public void mapExcelBody(NhanVienDTO dto, Row row) {
        Cell cell;
    ...
    @Override
    public NhanVienDTO mapExcelToDto(NhanVienDTO dto, int columnIndex, String cellValue) {
        if (dto == null)
            dto = new NhanVienDTO();
